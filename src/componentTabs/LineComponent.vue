    ...
    <Template>
        <div class="wrapperLeft">
            ...
            <div class="wrapperBottom">
                <Line :alignment="alignmentSelected"/>
            </div>
        </div>
        ...
        <div class="wrapperRight">
            ...
            <div class="attributes">
                ...
                <tr>
                    <td>
                        <RadioButton label="Horizontal" name="alignment" value="horizontal" @valueChanged="alignmentChanged" checked="true"/>
                    </td>
                    <td>
...
import Line from '/src/components/Line.vue'
    ...
    export default{
     ...
     data (){
         return{
            alignmentSelected: 'default',
         }
     },
     methods: {
         alignmentChanged(event){
            this.alignmentSelected = event
         }
     }
    }
</script>
